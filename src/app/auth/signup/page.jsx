        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-base">
              Join Nexis and start your travel journey
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-linear-to-br from-blue-600 to-purple-600 text-white py-3 text-base font-medium hover:shadow-lg transition-all"
                disabled={loading}
              >
